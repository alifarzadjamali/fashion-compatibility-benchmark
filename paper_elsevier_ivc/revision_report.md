...
- Ported the final scientific manuscript to *Image and Vision Computing* after checking its current scope and author guidance. The independent Elsevier package uses `elsarticle` preprint layout, numeric citations, six keywords, separate highlights, Elsevier declarations, and separately compiled supplementary material; no scientific result or conclusion was changed.
