...
- **Scope and instructions checked:** [Machine Vision and Applications aims and scope](https://link.springer.com/journal/138/aims-and-scope) and [submission guidelines](https://link.springer.com/journal/138/submission-guidelines). The study supplies the journal's requested technical machine-vision contribution and substantial experimental validation. The manuscript follows the stated 150--250-word abstract, 4--6 keyword, numbered-reference, sequential table/figure, title-page, declaration, and data-availability requirements.
- **Template checked:** [Springer Nature LaTeX author support](https://www.springernature.com/gp/authors/campaigns/latex-author-support) and the official December 2024 `sn-jnl` package. The manuscript uses the journal-recommended two-column `iicol` option with `sn-mathphys-num` and ships the unmodified `sn-jnl.cls` and `sn-mathphys-num.bst` files.
- **Supplementary packaging:** the separate PDF is identified in the paper as Online Resource 1 and can be uploaded as `ESM_1.pdf`, following the journal's electronic-supplement naming guidance.
- **Recent journal precedent:** Feng et al., “Benchmarking large and small MLLMs,” *Machine Vision and Applications* 36, 137 (2025), [DOI 10.1007/s00138-025-01762-0](https://doi.org/10.1007/s00138-025-01762-0), demonstrates that a systematic, technically motivated empirical benchmark can itself constitute a journal contribution. Recent 2025--2026 MVA controlled-evaluation and application papers were also inspected for presentation density and experimental framing. The present manuscript adopts that evidential standard without imitating their wording.
